...
"<head>"
"<meta charset=\"UTF-8\">"
"<title>Frases de Cientistas</title>"
"<style>"
"body {"
...
"</head>"
"<body>"
"<button id=\"fraseBotao\" onclick=\"alternarFrase()\">\"A imaginação é mais importante que o conhecimento.\" – Albert Einstein</button>"
...
"  document.getElementById('fraseBotao').textContent = frases[indice];"
"}"
"</script>"
"</body>"
"</html>",
